	...
	<view>
		...
		<view class="area-box">
			<view class="u-flex" :class="{ 'change':isChange }">
						...
						<scroll-view :scroll-y="true" style="height: 100%">
							<u-cell-group v-if="isChooseP">
								<u-cell-item v-for="(item,index) in citys" :title="item.label" :arrow="false" :index="index" :key="index"
								 @click="cityChange">
									<u-icon v-if="(isChooseC&&city===index)||(!isOpenArea&&city===index)" slot="right-icon" size="34" name="checkbox-mark"></u-icon>
								</u-cell-item>
							</u-cell-group>
						</scroll-view>
					</view>
				...
				<view v-if="isOpenArea" class="area-item">
					<view class="u-padding-10 u-bg-gray" style="height: 100%;">
						<scroll-view :scroll-y="true" style="height: 100%">
